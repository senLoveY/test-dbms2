...
- `POST /api/rooms/settings` — изменить настройки (только хост, в лобби)

### Настройки комнаты (хост)

| Параметр | Варианты |
|----------|----------|
| Время на вопрос | 15–60 сек |
| Число вопросов | 5 / 10 / 15 / 20 |
| Пауза на разбор | 2 / 3.5 / 5 сек |
| Макс. очков за вопрос | 500 / 1000 / 1500 |
| Мин. доля за скорость | 40% / 60% / 80% |
| Перемешивание вариантов | вкл / выкл |
| Автоотправка по таймеру | вкл / выкл |
| Частичные баллы | вкл / выкл |

Пресеты: **Быстрая**, **Стандарт**, **Экзамен**, **Тренировка**.

Для существующей БД выполните `supabase/room-settings-migration.sql`.
